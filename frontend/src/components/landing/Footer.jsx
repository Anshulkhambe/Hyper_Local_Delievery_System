...
// Custom SVG Social Icons (Lucide v1.0+ removed brand icons)
const Twitter = (props) => (
    ...
    <footer className="bg-slate-950 text-slate-400 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Optimizing hyper-local delivery for the modern retailer. Delivering speed, efficiency, and reliability since 2024.
            </p>
        ...
        <div className="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
          <p>© 2024 FleetOpt Technologies Inc. All rights reserved.</p>
